...
parser.add_argument('-perNmotif', required=  False, help='per number of motifs found value, default expected number per 1000 nucleotides')
parser.add_argument('--conPrint', required=  False, action='store_true', help='prints motif counts if specified')
