...
for sample in samples.keys():
    files = sorted([globFile('dataDir/0106/' + sample.split('.')[0] + '.1.cu.bo.hg19.coToBa.coToBe.unSo.coBeToSiFr.slBeb6.coToFiRa10.soBe.coBeToFa.gePyDi.soBe.seSt_Minus.bed'), \
    globFile('dataDir/0106/' + sample.split('.')[0] + '.1.cu.bo.hg19.coToBa.coToBe.unSo.coBeToSiFr.slBeb6.coToFiRa10.soBe.coBeToFa.gePyDi.soBe.seSt_Plus.bed')])
    for file in files:
        if file:
