...
sampleDict = generalUtils.table2dictionary(generalUtils.file('samples.2.csv'), 'sample')
...
cell = 'NHF1'
for key in keys:
    fileList = glob('dataDir/0106/*.1.cu.bo.hg19.coToBa.coToBe.unSo.coBeToSiFr.slBeb6.coToFiRa10.soBe.coBeToFa.gePyDi.soBe.seSt_*.co' + key + '.biCoToPo.txt')
