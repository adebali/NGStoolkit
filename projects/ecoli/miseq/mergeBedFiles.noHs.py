...
files = sorted(glob("dataDir/*2900K.bowtie_ecoli.sorted.bed.TT.noHS.*.gene.Cov.bed")) + sorted(glob("../rnaSeq/dataDir/RNA_*genesCov.nGene.nRead.bed"))
output = 'dataDir/genesMergedCounts_noHs.csv'
