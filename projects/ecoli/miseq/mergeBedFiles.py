...
files = sorted(glob("dataDir/*genesCov.nTT.nRead.bed")) + sorted(glob("../rnaSeq/dataDir/RNA_*genesCov.nGene.nRead.bed"))
...
unusedCol = 4
start = True
metaDataFiles = ["/nas02/home/a/d/adebali/ncbi/GCF_000005845.2/gene_GCF_000005845.2.txt"]
