...
code = 'echo -e chromosome"\t"start"\t"end"\t"gene"\t"score"\t"strand"\t"count"\t"time >mergedGeneCounts.txt'
os.system(code)
...
code = 'Rscript dcast.R mergedGeneCounts.txt mergedGeneCounts_dcasted.txt'
os.system(code)
