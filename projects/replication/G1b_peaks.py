...
PARSER.add_argument('-cutoff', required=False, default=500, type=int, help='cutoff for the called peak/region')
...
countCol = 7
code = 'bedCount2normalizedCount.py -i ' + tempfile3 + ' -m ' + str(args.s) + ' -l 1000 -c ' + str(countCol) + ' -o' + args.o
run(code)
