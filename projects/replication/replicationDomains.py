...
PARSER.add_argument('-keyword', required=True, help='keyword to select name (replication domain: UTZ DTZ ERD LRD)')
...
code = 'grep ' + args.keyword +  ' ' + args.a + ' | awk \'{print $1"\\t"$2"\\t"$3"\\t.\\t.\\t."}\' >' + tempfile1 
run(code)
